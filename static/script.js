...
function course_messages(){
  ...
  xhr.onreadystatechange = function(){
    ...
    xhr.open("GET", "/search_course", true);
    xhr.setRequestHeader('courseTitle', course);
    xhr.send();
  }

 function word_messages(){
  word = document.getElementById("wordSearch").value;
  var xhr = new XMLHttpRequest();
  var content =[];
